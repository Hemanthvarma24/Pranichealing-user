  ...
  return (
    <section className="px-6 py-8 max-w-xl mx-auto">
     <div className="flex items-center justify-between mb-2">
        ...
        <button className="text-sm text-black pt-4 font-medium">View All</button>
        </div>
      ...
      <div className="relative w-full rounded-xl border border-gray-300 p-6 shadow-md flex flex-col">
        ...
        <div className="absolute top-2 right-2 w-10 h-10 flex items-center justify-center rounded-full shadow-md">
          <Image
            src={whatsup}
            alt="WhatsApp"
            width={24}
