import { Smartphone, Brain, Activity, Moon, Heart, Droplets } from "lucide-react";
  ...
  return (
    <div className="px-6 py-8 bg-[#d5ede5] mb-8 text-center">
      <h2 className="text-lg font-medium text-gray-800">
        ...
        <span className="text-emerald-600 font-semibold text-xl">Pranic Healing Helps</span>
      </h2>
      <div className="grid grid-cols-3 gap-6 mt-6 text-white">
        {[
          ...
          { icon: <Droplets className="w-10 h-10" />, label: "General Cleansing" },
        ].map((item, index) => (
